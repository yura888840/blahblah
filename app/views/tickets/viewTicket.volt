...
<?php
    //@todo Notice: Array to string conversion
    error_reporting (7);
?>

<div class="panel-ticket">
    <input type="hidden" id="ticket_id" value="{{ ticket["_id"] }}">
    <div class="panel panel-ticket-height">
        <div class="panel-body relative panel-ticket-height">
            ...
            <div class="ticket-col ticket-col-footer col-md-7 col-sm-6">
                ...
                <div class="ticket-col-inner">
                    <div class="progress">
                        <div class="progress-bar bottom" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 2%;">
            ...
            <div class="ticket-col ticket-col-right col-md-3 col-sm-3" data-toggle="tooltip" data-title="Saved!">
                ...
                <div class="progress">
                    <div class="progress-bar right" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 2%;">
                        <span class="sr-only">2% Complete</span>
                    </div>
                </div>
                ...
                <div class="ticket-col-inner">
                    ...
                    <div class="row">
                        {% for field in formfieldlist %}
                            <!-- load neccessary template -->
                            {{ partial("tickets/partials/" ~ templates[field], ['data': ['label': forms.get(formname).label(field), 'element': forms.get(formname).render(field)]]) }}
                        {% endfor %}
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="my-awesome-dropzone-view"><i class="fa fa-paperclip"></i> Attach</label>

                                <form id="my-awesome-dropzone-view" class="dropzone"></form>
                            </div>
                        </div>
                    </div>
                    <label for="ticket_attachments">Ticket attachments list:</label>
                                ...
                                <div id="my-awesome-attachments-view" class="dropzone">
                                    {% for i, a in ticket['attach'] %}
                                        <a class="comment-download-file"
                                           href="{{ url('files/Tickets/') }}{{ ticket['_id'] }}/main/{{ a['uniqName'] }}"
                            ...
                            <div class="form-group">
                                <div id="my-awesome-attachments-view" class="dropzone">
                                    {% for i, a in comments_attachments %}
                                        <a class="comment-download-file"
                                           href="{{ url('files/Tickets/') }}{{ ticket['_id'] }}/comments/{{ a['commentId'] }}/{{ a['uniqName'] }}"
...
<script>
    ...
    ticket.url_postcomment = '{{ url("api/tickets/postcomment") }}/';
